...
return true\"><img src='icon/".$file['icon']."' width=25 height=24 border=0 alt='View This File'></a></td>";
    print "<td>&nbsp;<a href=\"javascript:void(window.open('".htmlentities($home_directory.$path.$file['filename'])."','newWin','toolbar=0, menubar=0, resizable=1, status=1'))\" OnMouseOut=\"window.status='GateQuest Documents Manager'; return true\" OnMouseOver=\"window.status='View This File';
...
return true\"><img src='icon/rename.gif' width=25 height=24 alt='$StrRenameFile' border=0></a></td>";
    if ($AllowDownload) print "<td align='center'><a href='$base_url&amp;path=".htmlentities(rawurlencode($path))."&amp;filename=".htmlentities(rawurlencode($file['filename']))."&amp;action=download' OnMouseOut=\"window.status='GateQuest Documents Manager'; return true\" OnMouseOver=\"window.status='Download This File';
